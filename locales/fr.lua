local Translations = {
    error = {
        ...
        no_weapon_in_hand = 'Vous n\'avez pas d\'arme fans vos mains.',
        ...
        attachment_already_on_weapon = 'Vous aviez déjà un/une %{value} sur votre arme.'
    },
    success = {
        reloaded = 'Rechargée'
    },

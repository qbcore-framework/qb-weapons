...
WeaponAttachments = {
    ...
    ['WEAPON_PISTOL'] = {
        ['defaultclip'] = {
            ...
            label = LangWeapons:t('weapon_attachments.defaultclip'),
            item = 'pistol_defaultclip',
            type = 'clip',
        },
        ['extendedclip'] = {
            component = 'COMPONENT_PISTOL_CLIP_02',
            label = LangWeapons:t('weapon_attachments.extendedclip'),
            item = 'pistol_extendedclip',
            type = 'clip',
        },
        ['flashlight'] = {
            component = 'COMPONENT_AT_PI_FLSH',
            label = LangWeapons:t('weapon_attachments.flashlight'),
            item = 'pistol_flashlight',
        },
        ['suppressor'] = {
            component = 'COMPONENT_AT_PI_SUPP_02',
            label = LangWeapons:t('weapon_attachments.suppressor'),
    ...
    ['WEAPON_COMBATPISTOL'] = {
        ...
        ['luxuryfinish'] = {
            ...
            label = LangWeapons:t('weapon_attachments.luxuryfinish'),
    ...
    ['WEAPON_REVOLVER'] = {
        ...
        ['vipvariant'] = {
            ...
            label = LangWeapons:t('weapon_attachments.vipvariant'),
            item = 'revolver_vipvariant',
            type = 'skin',
        },
        ['bodyguardvariant'] = {
            component = 'COMPONENT_REVOLVER_VARMOD_BOSS',
            label = LangWeapons:t('weapon_attachments.bodyguardvariant'),
    ...
    ['WEAPON_SNSPISTOL'] = {
        ...
        ['grip'] = {
            ...
            label = LangWeapons:t('weapon_attachments.woodgrip'),
            item = 'snspistol_grip',
        },                                            
    },
    ['WEAPON_HEAVYPISTOL'] = {
    ...
    ['WEAPON_MICROSMG'] = {
        ...
        ['scope'] = {
            ...
            label = LangWeapons:t('weapon_attachments.scope'),
            item = 'microsmg_scope',
        },
        ['suppressor'] = {
            component = 'COMPONENT_AT_AR_SUPP_02',
    ...
    ['WEAPON_SMG'] = {
        ...
        ['drum'] = {
            ...
            label = LangWeapons:t('weapon_attachments.drum'),
            item = 'smg_drum',
            type = 'clip',
        },
        ['flashlight'] = {
    ...
    ['WEAPON_COMBATPDW'] = {
        ...
        ['grip'] = {
            ...
            label = LangWeapons:t('weapon_attachments.grip'),
            item = 'combatpdw_grip',
        },
        ['scope'] = {
